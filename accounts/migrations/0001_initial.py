    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(blank=True, choices=[('Bank', 'Bank'), ('M-pesa Till', 'M-pesa Till'), ('M-pesa PayBill', 'M-pesa PayBill'), ('M-pesa Send Money', 'M-pesa Send Money')], max_length=100)),
